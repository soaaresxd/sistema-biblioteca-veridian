    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      >
        ...
        <DialogPrimitive.Close
          className="absolute top-4 right-4 rounded-sm opacity-70 transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 disabled:pointer-events-none"
          style={{ color: "#000000" }}
        >
...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      style={{ color: "#000000", fontWeight: "600", ...style }}
